...
ActiveRecord::Schema.define(version: 20140317143121) do
  ...
  create_table "customers", force: true do |t|
    t.string   "identity",   limit: 20, null: false
  ...
  create_table "employees", force: true do |t|
    ...
    t.string   "employee_type", limit: 30, null: false
  ...
  create_table "hours_stations", id: false, force: true do |t|
    t.integer  "hour_id"
    t.integer  "station_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "packages", force: true do |t|
    ...
    t.string   "addressee",    limit: 50,                          null: false
